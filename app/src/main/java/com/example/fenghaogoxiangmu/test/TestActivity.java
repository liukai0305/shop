package com.example.fenghaogoxiangmu.test;
...
import com.example.bigmage.ICallback;
import com.example.bigmage.ImageActivity;
...
public class TestActivity extends AppCompatActivity implements ICallback {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode == ImageActivity.CODE_RESULT){
            if(data != null){

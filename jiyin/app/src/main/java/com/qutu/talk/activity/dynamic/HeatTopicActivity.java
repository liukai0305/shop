...
import com.qutu.talk.adapter.ActiveListAdapter;
import com.qutu.talk.adapter.HeatTopicAdapter;
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        if (tag.equals("0")) {
            ...
            activeListAdapter.setOnItemClickListener((adapter, view, position) -> {
                if(activeListAdapter.getData() != null && activeListAdapter.getData().size()>0 &&  !TextUtils.isEmpty(activeListAdapter.getData().get(position).getUrl())){
...
//        });
    ...
    private void setSQHuoDong() {
        ...
        SpaceItemDecoration spaceItemDecoration = new SpaceItemDecoration(0, 20);
        heatTopicRecyc.addItemDecoration(spaceItemDecoration);
        heatTopicRecyc.setAdapter(activeListAdapter);
        getSQHD();
    }

...
public class MyZqAdapter extends BaseQuickAdapter<MyDress.DataBean.ZqinfoBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MyDress.DataBean.ZqinfoBean item) {
        ...
        helper.setText(R.id.tv_name,item.getZqname());
        if(item.getStatus()==1){

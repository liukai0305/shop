...
import com.qutu.talk.adapter.GiftAdapter;
import com.qutu.talk.adapter.GiftUserAdapter;
import com.qutu.talk.adapter.PackageGiftAdapter;
import com.qutu.talk.adapter.StoneGiftAdapter;
...
public class GiftWindow extends PopupWindow {
    ...
    public GiftWindow(MyBaseArmActivity context,
...
//        this.giftListBean.getData().setMy_wares(myWaresBeanList);
    ...
    private void initUser(MyBaseArmActivity context) {
...
//        };
        ...
        giftUserAdapter = new GiftUserAdapter(context, circleRecyclerUser,
                listNew);

...
import com.qutu.talk.adapter.RankJiedanAdapter;
 ...
 * 描述:接单排行榜
 */
public class RankJiedanFragment extends HeaderViewPagerFragment {
...
//    private View TMView;
    ...
    public RankJiedanAdapter rankAdapter;
    ...
    public static RankJiedanFragment getInstance(int tag, int type, int stateBarHeight) {
        RankJiedanFragment fragment = new RankJiedanFragment();
...
//        textYue.setSelected(false);
        ...
        rankAdapter = new RankJiedanAdapter(type);
...
//                    LogUtils.debugInfo("scrollY===" + mScrollY);
    ...
    private void loadData(String date) {
        showDialogLoding();
        /*RxUtils.loading(commonModel.jiedanbang(String.valueOf(id),
                date, String.valueOf(UserManager.getUser().getUserId())), this)*/
        RxUtils.loading(commonModel.jiedanbang(date), this)

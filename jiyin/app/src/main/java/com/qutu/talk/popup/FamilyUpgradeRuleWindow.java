...
//家族升级规则
public class FamilyUpgradeRuleWindow extends PopupWindow {
    ...
    public FamilyUpgradeRuleWindow(Activity context, ViewGroup view, CommonModel commonModel, RxErrorHandler rxErrorHandler) {
        super(context);
...
//        params.width = d.getWidth() - MyUtil.dip2px(context, 120);
    ...
    private void getRewardInfo() {
        RxUtils.loading(commonModel.getGXShuoMing(), context)

...
public class MiniCustomPopWindow implements PopupWindow.OnDismissListener {
    ...
    private MiniCustomPopWindow(Context context){
        mContext = context;
    }
     ...
     * @return
     */
    public MiniCustomPopWindow showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public MiniCustomPopWindow showAsDropDown(View anchor){
        if(mPopupWindow!=null){
    ...
    public MiniCustomPopWindow showAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public MiniCustomPopWindow showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
...
//                        Log.e(TAG,"out side ...");
    ...
    public static class PopupWindowBuilder{
        private MiniCustomPopWindow mCustomPopWindow;

        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new MiniCustomPopWindow(context);
        }
        ...
        public MiniCustomPopWindow create(){
            //构建PopWindow

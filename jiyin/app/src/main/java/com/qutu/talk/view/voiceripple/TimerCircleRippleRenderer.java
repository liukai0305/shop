...
//  private Paint timerPaint;
  ...
  public TimerCircleRippleRenderer(Paint ripplePaint, Paint rippleBackgroundPaint, double maxTimeMilliseconds, double currentTimeMilliseconds) {
    super(ripplePaint, rippleBackgroundPaint);
//    this.timerPaint = timerPaint;
  ...
  private void init() {
    ...
    timerBackgroundPaint.setColor(Color.parseColor("#00000000"));

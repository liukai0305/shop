...
public class DynamicWindow extends PopupWindow {
    ...
    public DynamicWindow(Activity context) {
        super(context);
        this.context = context;
        mMenuView = LayoutInflater.from(context).inflate(R.layout.dynamic_popu_item, null);
        juBao = mMenuView.findViewById(R.id.report_btn);

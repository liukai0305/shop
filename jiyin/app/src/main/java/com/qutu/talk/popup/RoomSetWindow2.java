...
import com.qutu.talk.adapter.RoomDiaAdapter;
 ...
 * 房间设置
 */
public class RoomSetWindow2 extends PopupWindow {
    ...
    public RoomSetWindow2(Activity context) {
        super(context);
...
//        this.update();
        ...
        list.add(new DialogBean("数值PK", R.mipmap.icon_room_pk));
        list.add(new DialogBean("打赏统计", R.mipmap.room_dstj));

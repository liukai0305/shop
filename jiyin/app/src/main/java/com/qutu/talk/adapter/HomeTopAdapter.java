 ...
 */
@ActivityScope
public class HomeTopAdapter extends BaseQuickAdapter<HotBean.DataBean, BaseViewHolder> {


    public HomeTopAdapter(int layoutResId, @Nullable List<HotBean.DataBean> data) {

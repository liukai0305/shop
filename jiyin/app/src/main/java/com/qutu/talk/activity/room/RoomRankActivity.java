...
import com.qutu.talk.view.HXLinePagerIndicatorThree;
...
public class RoomRankActivity extends MyBaseArmActivity {
    ...
    private static String[] AAA = new String[]{"财富榜", "魅力榜"}; //tab数据源
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        shuoMing.setOnClickListener(v -> {
            Intent intent = new Intent(RoomRankActivity.this, RankExplainActivity.class);
        ...
        public Fragment getItem(int i) {
            ...
            switch (i) {
                case 0:
                    ...
                    break;
                case 1:
                    RoomRankFragment roomRankFragment2 = RoomRankFragment.getInstance(3, 3, String.valueOf(uid));

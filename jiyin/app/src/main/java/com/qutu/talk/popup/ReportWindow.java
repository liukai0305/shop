...
import com.qutu.talk.adapter.ReportAdapter;
...
public class ReportWindow extends PopupWindow {
    ...
    public ReportWindow(MyBaseArmActivity context) {
        super(context);
...
//        this.update();
        ...
        reportAdapter.setOnItemClickListener((adapter, view, position) -> {
            ...
            if(position == list.size() - 1){
                ...
                if(context instanceof AdminHomeActivity || context instanceof AdminHome257Activity)

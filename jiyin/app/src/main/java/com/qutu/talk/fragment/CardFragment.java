...
import static com.qutu.talk.utils.Constant.DUIHUANCHENGGONG;
 ...
 * 老王
 */
public class CardFragment extends MyBaseArmFragment {
    @Inject
    ...
    private void getMyPackBaoShi() {
        RxUtils.loading(commonModel.my_pack("3"), this)
    ...
    public void receiveMsg(FirstEvent event) {
        ...
        } else if (DUIHUANCHENGGONG.equals(tag)) {

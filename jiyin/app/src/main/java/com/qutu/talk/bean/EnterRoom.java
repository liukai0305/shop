...
public class EnterRoom implements Serializable {
    ...
    public static class RoomInfoBean implements Serializable{
        ...
        public String hot;
        public String play_num = "0";//数值PK状态 0 关闭 1 开启
        public String gap;//房间排名，距离上一名还有多少差额
        public String exp = "";
        public String free_mic = "0";//1 开启了自由麦位 0 关闭了
        public int sort;//排麦序号
        public String num = "";//排麦人数,派单厅中的点单人数
        public String is_god = "0";//是否大神 1=是 0=否
        public String strto_time = "";//派单已经开始时间
        public String shiyin_sort = "0";//试音排序
        public String shiyin_num = "0";//试音总人数

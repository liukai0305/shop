...
import com.qutu.talk.app.ActivityLifecycleCallbacksImpl;
import com.qutu.talk.app.Api;
import com.qutu.talk.app.AppLifecyclesImpl;
import com.qutu.talk.app.FragmentLifecycleCallbacksImpl;
import com.qutu.talk.app.GlobalHttpHandlerImpl;
import com.qutu.talk.app.ResponseErrorListenerImpl;
import com.qutu.talk.app.converter.CodeGsonConverterFactory;
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlobalConfigModule.Builder builder) {
        ...
        Init1.init(BaseApplication.mApplication);

//        new SVGAParser.shareParser().init(this);
...
//                    retrofitBuilder.addConverterFactory(FastJsonConverterFactory.create());//比如使用 FastJson 替代 Gson
                    retrofitBuilder.addConverterFactory(CodeGsonConverterFactory.create());
                })
                .okhttpConfiguration((context1, okhttpBuilder) -> {//这里可以自己自定义配置 Okhttp 的参数
//                    okhttpBuilder.sslSocketFactory(); //支持 Https, 详情请百度
                    okhttpBuilder.connectTimeout(120, TimeUnit.SECONDS);//连接超时时间
                    okhttpBuilder.writeTimeout(120, TimeUnit.SECONDS);//写入超时时间
                    okhttpBuilder.readTimeout(120, TimeUnit.SECONDS);//读取超时时间

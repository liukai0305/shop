...
public class OpenBoxBean {
    ...
    public static class DataBean {
        ...
        private PushAwards push_awards;

        public PushAwards getPush_awards() {
            return push_awards;
        }

        public void setPush_awards(PushAwards push_awards) {
            this.push_awards = push_awards;
        }
        ...
        public static class PushAwards{

...
public class BoxGiftActivity extends Dialog {
    ...
    public BoxGiftActivity(@NonNull AdminHomeActivity context, OpenBoxBean openBoxBean, CommonModel commonModel, RxErrorHandler rxErrorHandler,int eggType) {
                ...
                .subscribe(new ErrorHandleSubscriber<OpenBoxBean>(rxErrorHandler) {
                    ...
                    public void onNext(OpenBoxBean openBoxBean) {
                        ...
                        if (openBoxBean.getCode() == 1) {
                            ...
                            isReShow=true;
                            BoxGiftActivity boxGiftActivity = new BoxGiftActivity(mContext, openBoxBean,mCommonModel,rxErrorHandler,currentTypeEgg);
...
//                        touMingDialog.dismiss();
    ...
    public void dismiss() {
        ...
        if(!isReShow){
            GemStoneDialog gemStoneDialog = new GemStoneDialog(mContext, mCommonModel, rxErrorHandler,currentTypeEgg);
            gemStoneDialog.show();
        }
    }
}

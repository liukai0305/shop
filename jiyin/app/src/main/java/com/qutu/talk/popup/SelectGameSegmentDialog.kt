...
class SelectGameSegmentDialog: Dialog {

    var mContext:Context? = null

    var mDataPriceList:ArrayList<SegmentItem>? = null

    var mAdapter: GameSegmentAdapter? = null


    var mOnSelctItemListner:onItemClickListener? = null

    constructor(context: Context,data:ArrayList<SegmentItem>):super(context, R.style.myChooseDialog){
        mContext = context
        mDataPriceList = data
    }
    ...
    private fun initRecyclerView() {
        ...
        mAdapter = GameSegmentAdapter(mContext, R.layout.item_select_segment, mDataPriceList)

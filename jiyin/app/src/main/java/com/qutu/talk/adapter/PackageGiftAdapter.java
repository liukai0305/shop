 ...
 * 描述:礼物的列表
 */
public class PackageGiftAdapter extends RecyclerView.Adapter<PackageGiftAdapter.VH> {
    ...
    public PackageGiftAdapter(Context context, MiniCircleRecyclerView recyclerView, List<GiftListBean.DataBean.MyWaresBean> data, boolean needLoop) {

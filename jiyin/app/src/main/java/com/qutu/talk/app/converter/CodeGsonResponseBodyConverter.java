...
public class CodeGsonResponseBodyConverter<T> implements Converter<ResponseBody, T> {
    ...
    public T convert(ResponseBody value) throws IOException {
        ...
        try {
            ...
            if (!"1".equals(object.optString("code"))) {//5 发送礼物太频繁
                if("5".equals(object.optString("code"))){
                    throw new ApiIOException("","5");
                } else {
                    throw new ApiIOException(object.optString("message"),object.optString("code"));
                }
            }
...
//            jsonReader.setLenient(true);
            ...
            throw new ApiIOException(e.getMessage(),null);
        } finally {
            value.close();
        }
    }

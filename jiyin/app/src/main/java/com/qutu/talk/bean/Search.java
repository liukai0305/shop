...
public class Search {
    ...
    public static class DataBean {
        private List<GmskillBean> gmskill;
        private List<UserBean> user;
        private List<RoomsBean> rooms;
        private List<DynamicsBean> dynamics;

        public List<GmskillBean> getGmskill() {
            return gmskill;
        }

        public void setGmskill(List<GmskillBean> gmskill) {
            this.gmskill = gmskill;
        }
        ...
        public static class GmskillBean{
            private int id;
            private String name;

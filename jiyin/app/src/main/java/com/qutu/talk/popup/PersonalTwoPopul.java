...
public class PersonalTwoPopul extends PopupWindow {
    ...
    public PersonalTwoPopul(Activity context) {
        super(context);
        this.context = context;
        mMenuView = LayoutInflater.from(context).inflate(R.layout.personal_two_popul, null);

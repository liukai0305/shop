 ...
 */
public class GxRankActivity extends MyBaseArmActivity implements MyPackBaoShiInter.onRankInter {
...
//    ImageView shuoMing;
    ...
    private static String[] AAA = new String[]{"贡献榜", "热门家族"};
...
//            startActivity(new Intent(this, AdminHomeActivity.class));
        ...
        shuoMing.setOnClickListener(v -> {
            Intent intent = new Intent(GxRankActivity.this, RankExplainActivity.class);
    ...
    private void initFragment() {
        ...
        mRankFragment1 = RankFragment.getInstance(2, 3, statusBarHeight);

        mRankFragment1.setmOnPageChangeLister(GxRankActivity.this);

        mRankFragment2 = FamilyRankFragment.getInstance(statusBarHeight);

        mRankFragment2.setmOnPageChangeLister(GxRankActivity.this);

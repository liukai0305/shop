 ...
 * 描述:排行榜
 */
public class FamilyGxRankFragment extends HeaderViewPagerFragment {
...
//    TextView textYue;
    ...
    private int jzid, statusBarHeight;
...
//    private View TMView;
    ...
    public static FamilyGxRankFragment getInstance(int jzid, int stateBarHeight) {
        FamilyGxRankFragment fragment = new FamilyGxRankFragment();
        Bundle bundle = new Bundle();
        bundle.putInt("jzid", jzid);
...
//                    LogUtils.debugInfo("scrollY===" + mScrollY);
        ...
        View view;
        FamilyGxRankActivity familyGxRankActivity = (FamilyGxRankActivity) getActivity();
        view = familyGxRankActivity.viewTouMing;
    ...
    private void loadData(String date) {
        showDialogLoding();
        RxUtils.loading(commonModel.getFamilyGxRank(date,jzid+""), this)

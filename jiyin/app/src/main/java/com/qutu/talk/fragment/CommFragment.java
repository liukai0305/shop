...
import com.qutu.talk.adapter.CommGridAdapter;
...
import com.qutu.talk.utils.GridSpacingItemDecoration;
...
public class CommFragment extends MyBaseArmFragment {
    ...
    protected void visibleToLoadData() {
        ...
        myList0.setLayoutManager(flexboxLayoutManager);

        commGridAdapter = new CommGridAdapter(R.layout.comm_grid_item);
        myList0.setAdapter(commGridAdapter);

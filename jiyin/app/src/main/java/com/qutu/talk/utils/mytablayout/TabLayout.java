...
import static android.support.design.resources.MaterialResources.*;
...
public class TabLayout extends HorizontalScrollView {
    ...
    private int mSelectedIndicatorPaint;
    int tabPaddingStart;
    int tabPaddingTop;
    int tabPaddingEnd;
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.slidingTabIndicator.setSelectedIndicatorColor(a.getColor(R.styleable.TabLayout_tabIndicatorColor, 300));
        this.setSelectedTabIndicator(getDrawable(context, a, R.styleable.TabLayout_tabIndicator));
        ...
        this.mTabLineOffset = a.getDimensionPixelSize(R.styleable.TabLayout_tabLineOffset, 0);
        ...
        try {
            ...
            this.tabTextColors = getColorStateList(context, ta, R.styleable.TextAppearance_android_textColor);
        } finally {
            ta.recycle();
        }

        if (a.hasValue(R.styleable.TabLayout_tabTextColor)) {
            this.tabTextColors = getColorStateList(context, a, R.styleable.TabLayout_tabTextColor);
        }
        ...
        this.tabIconTint = getColorStateList(context, a, R.styleable.TabLayout_tabIconTint);
        ...
        this.tabRippleColorStateList = getColorStateList(context, a, R.styleable.TabLayout_tabRippleColor);
        this.tabIndicatorAnimationDuration = a.getInt(R.styleable.TabLayout_tabIndicatorAnimationDuration, 0);
    ...
    private static ColorStateList createColorStateList(int defaultColor, int selectedColor) {
        ...
        int i1 = i + 1;
        states[i1] = EMPTY_STATE_SET;
        colors[i1] = defaultColor;
        ++i;
                ...
                if (startLeft != targetLeft || startRight != targetRight) {
                    ...
                    animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        public void onAnimationUpdate(ValueAnimator animator) {
                            ...
                            TabLayout.SlidingTabIndicator.this.setIndicatorPosition(AnimationUtils.lerp(startLeft, finalTargetLeft, fraction), AnimationUtils.lerp(startRight, finalTargetRight, fraction));
                        }
                    });
...
//            }
            ...
            if (indicatorLeft >= 0 && indicatorRight > indicatorLeft) {
                if (mTabLineOffset == 0)
                    canvas.drawRect(indicatorLeft, getHeight() - selectedIndicatorHeight,
                            indicatorRight, getHeight(), selectedIndicatorPaint);
                else {
                    //Original TabLine Offset
                    int width = indicatorRight - indicatorLeft;
                    //Tab Center point coordinate
                    int tabCenter = indicatorLeft + width / 2;
                    RectF oval3 = new RectF(tabCenter - mTabLineOffset, getHeight() - selectedIndicatorHeight,
                            indicatorRight - width / 2 + mTabLineOffset, getHeight());
                    canvas.drawRoundRect(oval3, 30, 30, selectedIndicatorPaint);
                }
            }

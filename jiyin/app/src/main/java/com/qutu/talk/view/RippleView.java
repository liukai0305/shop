...
import com.qutu.talk.bean.CircleBean;
import com.qutu.talk.bean.CircleBeanEvaluator;
...
//    }
    ...
    public void addCircle(float maxWidth){
        ...
        mId++;
        int startWidth = (int) (maxWidth - QMUIDisplayHelper.dpToPx(15));
//        int startWidth = (int) (maxWidth-10);
//        LogUtils.debugInfo("开始半径===="+startWidth);
        CircleBean c = new CircleBean(String.valueOf(mId),startWidth, 255, maxWidth);
        mRipples.add(c);
        invalidate();
    }
...
//        }
    ...
    private void startViewAnimation(CircleBean c) {
        ...
        ValueAnimator valueAnimator = ValueAnimator.ofObject(new CircleBeanEvaluator(endBean.width-startBean.width,startBean.width),startBean,endBean);

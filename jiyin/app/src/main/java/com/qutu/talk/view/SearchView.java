...
import com.qutu.talk.di.ICallBack;
import com.qutu.talk.di.bCallBack;
...
public class SearchView extends LinearLayout {
    ...
    // 搜索框组件
    private ClearEditText et_search; // 搜索按键
...
//    private SQLiteDatabase db;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int defaultColor = context.getResources().getColor(R.color.font_999999); // 默认颜色 = 灰色
...
//                queryData(tempName); // ->>关注1
                if (tempName.isEmpty() || tempName.equals("")) {

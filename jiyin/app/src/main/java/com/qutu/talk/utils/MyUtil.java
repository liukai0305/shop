...
*/
    ...
    public static int[] calculatePopWindowPos(final View anchorView, final View contentView) {
        ...
        // 获取屏幕的高宽
        final int screenHeight = RongUtils.getScreenHeight();
    ...
    public static boolean isPopWindowUp(final View anchorView, final View contentView) {
        final int windowPos[] = new int[2];
        final int anchorLoc[] = new int[2];
        // 获取锚点View在屏幕上的左上角坐标位置
        anchorView.getLocationOnScreen(anchorLoc);
...
//            duration = mmr.extractMetadata(android.media.MediaMetadataRetriever.METADATA_KEY_DURATION);
        ...
        com.jess.arms.utils.LogUtils.debugInfo("音频时长", "duration " + duration);
        return duration;
    }

    public static void setListData() {
        ArrayList<ArrayList<ArrayList<PaiDanTimeBean>>> listTotal = new ArrayList<ArrayList<java.util.ArrayList<PaiDanTimeBean>>>();

        ArrayList<ArrayList<PaiDanTimeBean>> hour = new ArrayList<>();
        ArrayList<ArrayList<PaiDanTimeBean>> hour1 = new ArrayList<>();

        listTotal.add(hour);
        listTotal.add(hour1);

        ArrayList<PaiDanTimeBean> minate = new ArrayList<>();

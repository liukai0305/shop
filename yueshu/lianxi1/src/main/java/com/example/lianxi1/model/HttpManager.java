package com.example.lianxi1.model;

import android.util.Log;

import com.example.lianxi1.api.ApiServie;
import com.example.lianxi1.common.Constants;
...
public class HttpManager {
     ...
     * @return
     */
    public ApiServie getYunApi(){
        if(yunApi == null){
            yunApi = getRetrofit(Constants.Base_YunUrl).create(ApiServie.class);
        }
        return yunApi;
    }

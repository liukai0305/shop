...
public class RecommendActivityAdapter1 extends BaseAdapter {
    ...
    public RecommendActivityAdapter1(List data, Context context) {
        super(data, context);
    }

    @Override
    protected int getLayout() {
        return R.layout.item_activity_recommend;
    }
    @Override
...
//            //使用富文本修改 内容中的文字颜色
       ...
       // }
        mRecommedTvText.setText(detailBean.getContent());

package com.example.xiangmuyi.model;

import android.util.Log;


import com.example.xiangmuyi.common.Constants;
import com.example.xiangmuyi.model.api.TpApi;
import com.example.xiangmuyi.model.api.UploadApi;
import com.example.xiangmuyi.model.api.UserApi;
import com.example.xiangmuyi.utils.DigestUtils;
...
public class HttpManager {
    ...
    public UserApi getUserApi(){
        if(userApi == null){
            userApi = getRetrofit(Constants.Base_UserUrl).create(UserApi.class);
        }
        return userApi;
    }
    /**
    ...
    public UploadApi getUploadApi(){
        if(uploadApi == null){
            uploadApi = getRetrofit(Constants.Base_UploadUrl).create(UploadApi.class);
        }
        return uploadApi;
    }
}

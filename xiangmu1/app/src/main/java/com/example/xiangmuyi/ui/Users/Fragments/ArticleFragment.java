...
import com.example.xiangmuyi.adapter.homeadapter.WenZhangAdapter;
...
public class ArticleFragment extends BaseFragment<IUsers.Persenter> implements IUsers.View {


    @BindView(R.id.rcy)
    RecyclerView rcy;
    private ArrayList<PersonalArticleBean.DataBean.ArticlesBean> list;
    private WenZhangAdapter adapter;


    @Override
    protected int getLayout() {
        return R.layout.fragment_article1;
    }
    ...
    protected void initView() {
        ...
        list = new ArrayList<>();
        adapter = new WenZhangAdapter(list, getActivity());
